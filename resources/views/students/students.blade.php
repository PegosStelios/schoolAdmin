        ...
        <div class="container max-w-7xl mx-auto mt-8">
            <div class="mb-4">
                ...
                <div class="flex justify-end">
                    <a href="/students/createStudent"><button
                            class="px-4 py-2 rounded-md bg-sky-500 text-sky-100 hover:bg-sky-600">Add Student</button></a>
                </div>
            </div>
                            ...
                            <tbody class="bg-white">
                                @foreach ($students as $student)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                            <div class="text-sm leading-5 text-gray-900">{{ $student->name }}
                                                {{ $student->lastName }}
                                            </div>
                                        </td>
                                        ...
                                        <td
                                            class="text-sm font-medium leading-5 text-center whitespace-no-wrap border-b border-gray-200 ">
                                            <a href="/students/student/{{ $student->id }}"
                                        ...
                                        <td class="text-sm font-medium leading-5 whitespace-no-wrap border-b border-gray-200 ">
                                            <form method="POST" action="/students/deleteStudent/{{ $student->id }}">\
                                                @csrf
                                                @method('DELETE')
